 ...
 */
final class Version20230116095040 extends AbstractMigration
{
...
//        $this->addSql('DROP TABLE cron_report');
        $this->addSql('ALTER TABLE ongoing_decision ADD current_step VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ongoing_decision DROP current_step');
    }
}
